/* Lenis плавный скролл + GSAP ScrollTrigger reveal (монохром, PRM) */
(() => {
  ...
  // Подмена фото на монохромный SVG, если файла нет/битый
  ...
  // Форма: если action пустой — mailto:
